...
export const MusicReleasePage = ({data}: {data: MusicReleaseData}) => {
    ...
    return (
        <Container className="p-5 flex flex-col justify-center items-center gap-5" style={{backgroundColor: theme.colors.background}}>
            <span onClick={router.back} style={{marginTop: "10vh"}} className="self-start mb-5">←  Back</span>
        <Image width={300} height={300} src={data.coverArt.url} alt={data.title} style={{width: "30vh", height: "30vh", maxHeight: 500, maxWidth: 500}} />
